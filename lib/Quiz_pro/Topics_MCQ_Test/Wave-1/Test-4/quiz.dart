...
class TestFourQuiz extends StatefulWidget {
  @override
  _TestFourQuizState createState() => _TestFourQuizState();
}

class _TestFourQuizState extends State<TestFourQuiz> {
  List questions;
  String currentTitle;
  ...
  Future<void> getQuestions() async {
    final String response =
        await rootBundle.loadString('assets/test_four.json');
  ...
  void nextQuestion(BuildContext context) {
    ...
    if (actualQuestion + 1 < this.questions.length) {
      ...
      Navigator.pushReplacementNamed(context, 'testfourresult', arguments: {
