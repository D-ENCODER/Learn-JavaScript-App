...
class TestFiveQuiz extends StatefulWidget {
  @override
  _TestFiveQuizState createState() => _TestFiveQuizState();
}

class _TestFiveQuizState extends State<TestFiveQuiz> {
  List questions;
  String currentTitle;
  ...
  Future<void> getQuestions() async {
    final String response =
        await rootBundle.loadString('assets/test_five.json');
  ...
  void nextQuestion(BuildContext context) {
    ...
    if (actualQuestion + 1 < this.questions.length) {
      ...
      Navigator.pushReplacementNamed(context, 'testfiveresult', arguments: {
