...
class TestEightQuiz extends StatefulWidget {
  @override
  _TestEightQuizState createState() => _TestEightQuizState();
}

class _TestEightQuizState extends State<TestEightQuiz> {
  List questions;
  String currentTitle;
  ...
  Future<void> getQuestions() async {
    final String response =
        await rootBundle.loadString('assets/test_eight.json');
  ...
  void nextQuestion(BuildContext context) {
    ...
    if (actualQuestion + 1 < this.questions.length) {
      ...
      Navigator.pushReplacementNamed(context, 'testeightresult', arguments: {
