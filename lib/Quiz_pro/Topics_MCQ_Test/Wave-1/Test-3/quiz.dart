...
class TestThreeQuiz extends StatefulWidget {
  @override
  _TestThreeQuizState createState() => _TestThreeQuizState();
}

class _TestThreeQuizState extends State<TestThreeQuiz> {
  List questions;
  String currentTitle;
  ...
  Future<void> getQuestions() async {
    final String response =
        await rootBundle.loadString('assets/test_three.json');
  ...
  void nextQuestion(BuildContext context) {
    ...
    if (actualQuestion + 1 < this.questions.length) {
      ...
      Navigator.pushReplacementNamed(context, 'testthreeresult', arguments: {
