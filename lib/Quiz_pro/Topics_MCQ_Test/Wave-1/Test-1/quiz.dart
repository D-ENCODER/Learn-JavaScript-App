...
class TestOneQuiz extends StatefulWidget {
  @override
  _TestOneQuizState createState() => _TestOneQuizState();
}

class _TestOneQuizState extends State<TestOneQuiz> {
  List questions;
  String currentTitle;
  ...
  Future<void> getQuestions() async {
    final String response = await rootBundle.loadString('assets/test_one.json');
  ...
  void nextQuestion(BuildContext context) {
    ...
    if (actualQuestion + 1 < this.questions.length) {
      ...
      Navigator.pushReplacementNamed(context, 'testoneresult', arguments: {
