...
class TestSixQuiz extends StatefulWidget {
  @override
  _TestSixQuizState createState() => _TestSixQuizState();
}

class _TestSixQuizState extends State<TestSixQuiz> {
  List questions;
  String currentTitle;
  ...
  Future<void> getQuestions() async {
    final String response = await rootBundle.loadString('assets/test_six.json');
  ...
  void nextQuestion(BuildContext context) {
    ...
    if (actualQuestion + 1 < this.questions.length) {
      ...
      Navigator.pushReplacementNamed(context, 'testsixresult', arguments: {
