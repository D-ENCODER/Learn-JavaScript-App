...
class TestSevenQuiz extends StatefulWidget {
  @override
  _TestSevenQuizState createState() => _TestSevenQuizState();
}

class _TestSevenQuizState extends State<TestSevenQuiz> {
  List questions;
  String currentTitle;
  ...
  Future<void> getQuestions() async {
    final String response =
        await rootBundle.loadString('assets/test_seven.json');
  ...
  void nextQuestion(BuildContext context) {
    ...
    if (actualQuestion + 1 < this.questions.length) {
      ...
      Navigator.pushReplacementNamed(context, 'testsevenresult', arguments: {
