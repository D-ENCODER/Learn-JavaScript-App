...
import 'package:quiz_app/pages/home_page/quiz_option.dart';

class TestTwoQuiz extends StatefulWidget {
  @override
  _TestTwoQuizState createState() => _TestTwoQuizState();
}

class _TestTwoQuizState extends State<TestTwoQuiz> {
  List questions;
  String currentTitle;
  ...
  Future<void> getQuestions() async {
    final String response = await rootBundle.loadString('assets/test_two.json');
  ...
  void nextQuestion(BuildContext context) {
    ...
    if (actualQuestion + 1 < this.questions.length) {
      ...
      Navigator.pushReplacementNamed(context, 'testtworesult', arguments: {
