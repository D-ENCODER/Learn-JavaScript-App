...
class TestNineQuiz extends StatefulWidget {
  @override
  _TestNineQuizState createState() => _TestNineQuizState();
}

class _TestNineQuizState extends State<TestNineQuiz> {
  List questions;
  String currentTitle;
  ...
  Future<void> getQuestions() async {
    final String response =
        await rootBundle.loadString('assets/test_nine.json');
  ...
  void nextQuestion(BuildContext context) {
    ...
    if (actualQuestion + 1 < this.questions.length) {
      ...
      Navigator.pushReplacementNamed(context, 'testnineresult', arguments: {
