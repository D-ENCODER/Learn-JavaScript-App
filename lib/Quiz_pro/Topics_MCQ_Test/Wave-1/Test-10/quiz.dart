...
class TestTenQuiz extends StatefulWidget {
  @override
  _TestTenQuizState createState() => _TestTenQuizState();
}

class _TestTenQuizState extends State<TestTenQuiz> {
  List questions;
  String currentTitle;
  ...
  Future<void> getQuestions() async {
    final String response = await rootBundle.loadString('assets/test_ten.json');
  ...
  void nextQuestion(BuildContext context) {
    ...
    if (actualQuestion + 1 < this.questions.length) {
      ...
      Navigator.pushReplacementNamed(context, 'testtenresult', arguments: {
