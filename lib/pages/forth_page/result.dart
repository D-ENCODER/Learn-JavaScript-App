...
import 'package:quiz_app/pages/forth_page/quiz.dart';
import 'package:quiz_app/pages/second_page/second_page.dart';

class ForthResult extends StatelessWidget {
  @override
                  ...
                  Container(
                    ...
                    child: Image(
                      image: AssetImage((args['corrects'] >=
                              3) //TODO HERE YOU WILL HAVE TO CHANGE THIS VALUE IN EVERY QUIZ
