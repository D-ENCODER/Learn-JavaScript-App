...
class ForthQuiz extends StatefulWidget {
  @override
  _ForthQuizState createState() => _ForthQuizState();
}

class _ForthQuizState extends State<ForthQuiz> {
  List questions;
  String currentTitle;
  ...
  Future<void> getQuestions() async {
    final String response =
        await rootBundle.loadString('assets/third_quiz.json');
  ...
  void nextQuestion(BuildContext context) {
    ...
    if (actualQuestion + 1 < this.questions.length) {
      ...
      Navigator.pushReplacementNamed(context, 'forthresult', arguments: {
